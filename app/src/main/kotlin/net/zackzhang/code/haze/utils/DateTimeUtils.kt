...
fun parseDate(date: String?) = try {
    ...
    wLog("DateTimeUtils", "parseDate", "Will return `null` due to error = $e")
    null
}
...
fun parseTime(time: String?) = try {
    ...
    wLog("DateTimeUtils", "parseTime", "Will return `null` due to error = $e")
    null
}
...
fun parseDateTime(dateTime: String?) = try {
    ...
    wLog("DateTimeUtils", "parseDateTime", "Will return `null` due to error = $e")
    null
}
...
fun parseTimeZone(timeZone: String?) = try {
    ...
    wLog("DateTimeUtils", "parseTimeZone", "Will return `null` due to error = $e")
    null
...
fun parseUtcOffset(utcOffset: String?) = try {
    ...
    wLog("DateTimeUtils", "parseUtcOffset", "Will return `null` due to error = $e")
    null
}
