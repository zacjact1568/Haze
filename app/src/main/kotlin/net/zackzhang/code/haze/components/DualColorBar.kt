package net.zackzhang.code.haze.components
...
import net.zackzhang.code.haze.utils.RoundPosition
import net.zackzhang.code.haze.utils.drawRoundRect
import net.zackzhang.code.haze.utils.ensureNotEmpty
import net.zackzhang.code.haze.utils.getDimension
import net.zackzhang.code.haze.utils.intersection
...
class DualColorBar @JvmOverloads constructor(
    ...
    init {
        ...
        var barColorStart = 0
        var barColorEnd = 0
        context.withStyledAttributes(attrs, R.styleable.DualColorBar) {
