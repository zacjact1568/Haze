...
import net.zackzhang.code.haze.exception.HeWeatherServiceException
import net.zackzhang.code.haze.model.network.bean.HeWeatherApi
import net.zackzhang.code.haze.model.bean.Weather
import net.zackzhang.code.haze.model.network.bean.HeWeatherSearch
import net.zackzhang.code.haze.model.network.service.HeWeatherApiService
import net.zackzhang.code.haze.model.network.service.HeWeatherSearchService
